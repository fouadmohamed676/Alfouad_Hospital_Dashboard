                ...
                <div class="card-content">
                    <div class="card-body">
                        ...
                        <div class="form-panel">
                            <div class="form">
                              <form class="cmxform form-horizontal style-form" id="signupForm" method="POST" action="{{url('Nurses/save_update/'.$nurses->id)}}">
                               ...
                               @method('put')
                                <div class="form-group ">
                                  ...
                                  <div class="col-lg-10">
                                    <input class=" form-control" id="firstname" required value="{{$nurses->name}}" name="name" type="text" />
                                  </div>
                                </div>
                                <div class="form-group ">
                                    <label for="email" class="control-label col-lg-2">الايميل</label>
                                    <div class="col-lg-10">
                                      <input class="form-control " id="email" value="{{$nurses->email}}" name="email" type="email" />
                                    </div>
                                  </div>
                                <div class="form-group ">
                                  <label for="lastname" class="control-label col-lg-2">العنوان</label>
                                  <div class="col-lg-10">
                                    <input class=" form-control" id="lastname" required value="{{$nurses->title}}"  name="title" type="text" />
                                  </div>
                                </div>
                                <div class="form-group ">
                                    <label for="phone" class="control-label col-lg-2">الهاتف</label>
                                    <div class="col-lg-10">
                                      <input class="form-control" value="{{$nurses->phone}}" required id="phone" name="phone" type="number" />
                                    </div>
                                  </div>
                                ...
                                <div class="form-group ">
                                  ...
                                  <div class="col-lg-10">
                                    <select class="form-control" required value="{{$nurses->gender_id}}"  name="gender_id">
