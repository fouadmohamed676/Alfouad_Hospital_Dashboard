        ...
        <ul class="side-nav">
            ...
            <li class="side-nav-item">
                ...
                <div class="collapse" id="sidebarEcommerce">
                    <ul class="side-nav-second-level">
                        <li>
                            <a href="{{route('hospital.show') }}">Show <span class="badge rounded-pill badge-success-lighten font-10 float-end">New</span> </a>
                        </li>
                        <li>
                            <a href="{{route('hospital.create') }}">Create</a>
                        </li>
                ...
                <div class="collapse" id="sidebar">
                    <ul class="side-nav-second-level">
                        <li>
                            <a href="{{route('doctors.show') }}">Show</a>
                        </li>
                        <li>
