                ...
                <div class="card-content">
                    <div class="card-body">
                        ...
                        <div class="form-panel">
                            <div class="form">
                              <form class="cmxform form-horizontal style-form" id="signupForm" method="POST" action="{{url('sick/save_update/'.$sick->id)}}">
                               ...
                               @method('put')
                                <div class="form-group ">
                                  ...
                                  <div class="col-lg-10">
                                    <input class=" form-control" id="firstname" required value="{{$sick->name}}" name="name" type="text" />
                                  </div>
                                </div>
                                <div class="form-group">
